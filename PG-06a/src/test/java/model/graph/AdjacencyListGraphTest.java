...
class AdjacencyListGraphTest {
    ...
    @Test
    void testAdjacencyListGraph() throws GraphException, ListException, StackException, QueueException {
    ...
    void testDfsBfsDirected() throws Exception {
        AdjacencyListGraph<Integer> graph = new AdjacencyListGraph<>(5, true);
    ...
    void testDegreesAndEdgesUndirected() throws Exception {
        AdjacencyListGraph<Integer> graph = new AdjacencyListGraph<>(5, false);
        for (int i = 0; i <= 4; i++) graph.addVertex(i);
        graph.addEdge(0, 1);
        graph.addEdge(0, 2);
        graph.addEdge(0, 3);
